...
from fire_lab.envs import DirectRLVlaEnv
from isaaclab.sim.spawners.from_files import GroundPlaneCfg, spawn_ground_plane
from isaaclab.utils.assets import ISAAC_NUCLEUS_DIR
from isaaclab.utils.math import axis_angle_from_quat

from fire_lab.tasks.direct.base_line.factory import factory_control, factory_utils
from fire_lab.tasks.direct.base_line.factory.factory_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FactoryEnvCfg


class FactoryEnv(DirectRLVlaEnv):
    cfg: FactoryEnvCfg
