...
from lerobot_policy_gr00t.configuration_gr00t import Gr00tConfig
...
from lerobot_policy_gr00t.processor_franka import FrankaStateActionTransformStep
...
def make_gr00t_pre_post_processors(
    ...
    input_steps: list[ProcessorStep] = [
        ...
        AddBatchDimensionProcessorStep(),
        # # add FrankaStateActionTransformStep
        # FrankaStateActionTransformStep(),
