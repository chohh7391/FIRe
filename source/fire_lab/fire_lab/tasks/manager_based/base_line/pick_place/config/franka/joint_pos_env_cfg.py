...
import fire_lab.tasks.manager_based.base_line.pick_place.mdp as mdp
from fire_lab.tasks.manager_based.base_line.lift.config.franka.joint_pos_env_cfg import FrankaCubeLiftEnvCfg
