...
@configclass
class ForgePi05Task(FactoryTask):
...
@configclass
class ForgePi05PegInsert(PegInsert, ForgePi05Task):
    contact_penalty_scale: float = 0.01


@configclass
class ForgePi05GearMesh(GearMesh, ForgePi05Task):
    contact_penalty_scale: float = 0.0025


@configclass
class ForgePi05NutThread(NutThread, ForgePi05Task):
    contact_penalty_scale: float = 0.0025